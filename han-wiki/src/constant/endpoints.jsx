...
const ENDPOINTS = {
  ...
  KOREAN_POPULAR: `${BASE_URL}/movie/popular?api_key=${API_KEY}&with_origin_country=KR&primary_release_date.gte=2020-12-01&adult=false`,
  JAPAN_POPULAR: `${BASE_URL}/movie/popular?api_key=${API_KEY}&with_original_language=ja&primary_release_date.gte=2019-01-01`,
  GET_DETAIL(id) {
